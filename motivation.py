...
def show():
    ...
    with st.expander("From Academic to Tech Lead", expanded=True):
        ...
        "After completing my PhD in Computer Science, I was worried about transitioning to industry. 
        Through structured interview preparation and confidence building, I successfully landed a 
        Senior Software Engineer role and was promoted to Tech Lead within two years. The key was 
        learning to effectively communicate my research and problem-solving skills in interviews."
        
        *- Dr. Maria Chen, Technical Lead at CloudTech Solutions*
        """)
    ...
    with st.expander("Career Changer Success"):
        ...
        *- Rebecca Thompson, Software Developer at TechStart Inc.*
        """)
    ...
    with st.expander("First-Generation Tech Professional"):
        ...
        I used this platform to practice interviewing and build confidence. The structured approach helped 
        me land a role at a major tech company, where I now mentor others from similar backgrounds."
        
        *- Priya Patel, Senior Software Engineer at InnovateTech*
        """)
